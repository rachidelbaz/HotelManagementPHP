...
<!-- div search -->
<div class="row">
    <h1 class="mx-auto mb-1"> Booking </h1>
</div>
<hr />
<div class="row">
    <div class="col col-3">
    ...
    <div class="col col-9">
        <div class="input-group mb-2">
            <form id="searchForm" class="col " action="<?php echo URLROOT . "/{$data['controller']}" ?>" method="POST">
                <input type="text" class="form-control" name="search" value="<?php echo $data['search'] ?>" placeholder="Search! by client or accomodation" aria-describedby="button-addon4">
            </form>
