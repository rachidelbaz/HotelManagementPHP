					...
					<div class="gallery_slider_container">
						<div class="owl-carousel owl-theme gallery_slider">
							...
							<div class="gallery_slide">
								<img src="<?php echo URLROOT;?>./public/images/gallery_1.jpg" alt="">
							...
							<!-- Slide -->
							<div class="gallery_slide">
								<img src="<?php echo URLROOT?>/public/images/gallery_2.jpg" alt="">
								<div class="gallery_overlay">
									<div class="text-center d-flex flex-column align-items-center justify-content-center">
										<a href="#">
											<span>+</span>
							...
							<!-- Slide -->
							<div class="gallery_slide">
								<img src="<?php echo URLROOT;?>/public/images/gallery_3.jpg" alt="">
								<div class="gallery_overlay">
									<div class="text-center d-flex flex-column align-items-center justify-content-center">
										<a href="#">
											<span>+</span>
							...
							<!-- Slide -->
							<div class="gallery_slide">
								<img src="<?php echo URLROOT;?>/public/images/gallery_4.jpg" alt="">
								<div class="gallery_overlay">
									<div class="text-center d-flex flex-column align-items-center justify-content-center">
										<a href="#">
											<span>+</span>
				...
				<div class="col-xl-6 order-xl-1 order-2">
					<div class="rooms_slider_container">
						<div class="owl-carousel owl-theme rooms_slider">
							...
							<!-- Slide -->
							<div class="slide">
								<div class="background_image" style="background-image:url(<?php echo URLROOT?>/public/images/rooms_1.jpg)"></div>
							</div>
				...
				<div class="col-xl-6">
					<div class="rooms_slider_container">
						<div class="owl-carousel owl-theme rooms_slider">
							...
							<!-- Slide -->
							<div class="slide">
								<div class="background_image" style="background-image:url(<?php echo URLROOT?>/public/images/rooms_2.jpg)"></div>
							</div>
	...
	<div class="discover">
		...
		<div class="discover_slider_container">
			<div class="owl-carousel owl-theme discover_slider">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(<?php echo URLROOT?>/public/images/discover_1.jpg)"></div>
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(<?php echo URLROOT?>/public/images/discover_2.jpg)"></div>
					<div class="discover_overlay d-flex flex-column align-items-center justify-content-center">
				...
				<!-- Slide -->
				<div class="slide">
					<div class="background_image" style="background-image:url(<?php echo URLROOT?>/public/images/discover_3.jpg)"></div>
					<div class="discover_overlay d-flex flex-column align-items-center justify-content-center">
						...
						<div class="owl-carousel owl-theme testimonials_slider">
							...
							<div>
								...
								<div class="testimonial_author text-center">
									<div class="testimonial_author_image"><img src="<?php echo URLROOT?>/public/images/author_1.jpg" alt=""></div>
